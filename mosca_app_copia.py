...
def exe_mosca_pipe(id, name, samples_id,exe_mosca):
    ...
    return render_template('exe_mosca_pipe.html', id=id, name = name, samples_id=samples_id, exe_mosca=exe_mosca, steps=steps)

###############################################################
@app.route('/krona', methods = ['GET', 'POST'])
def krona():

    return send_file('templates/all_taxonomy.html')
